...
# client = LineClient()
client = LineClient(authToken='EoPZoZLXPfJMIeFlJNI7.mMD8f775uswF2ssZgJVO5W.H1Om8DTtC0vA5i96Zw23M6Ea3bVNxGiuFLureKmRVO8=')
client.log("Auth Token : " + str(client.authToken))
# client.log("Auth Token : Eo0LHwZSt7Nqq7Gwjoh0.JUROxzdkKD3c/MrJQ951aa.uxGSbC3G+WLtqabnwWuS0v3GQwHWjgnEWS8zPeng6ko=")

channel = LineChannel(client)
client.log("Channel Access Token : " + str(channel.channelAccessToken))
# client.log("Channel Access Token : Mi5z5k6320rW2RKmSIziXF0rztfzQvxVybcD7/zPZVI7xSSWLGNT8bptJz/OhFlBAP+eCKEk58k3KptvOEGhVW6hSCv6hsD+Aok///oP+0Zt8drsbVFG9Xyl6S7Zx5LpKKVxPtGxbMCMrMu5wEU4D1ZyoAV+nALhpKNrR4VAhV4=")
